...
#####Variables#####################################################################
settingsFile = "my_settings.yml"
settings = yaml.safe_load(open(settingsFile))
bibKeys = yaml.safe_load(open("bibtex_analysis.yml"))
...
#def BibMaker(metaData):
    #for k,v in metaData.items():
        #recordFile = open(rCite+".bib", "w")
        #print(completeRecord,file= recordFile)
...
###Bib-Datei
###get completeRecord 
###copy complete Record into folder
### not sure how to use the variables from our bibload function in
###the next function